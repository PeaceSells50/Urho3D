...
namespace Urho3D
{
	...
	protected:
		...
		void HandleHierarchyContextCopy(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextCut(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextDelete(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextPaste(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextEnableDisable(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextCreateReplicatedNode(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextCreateLocalNode(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextDuplicate(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextResetToDefault(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextResetPosition(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextResetRotation(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextResetScale(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextUnparent(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextUIElementCloseUILayout(StringHash eventType, VariantMap& eventData);
		void HandleHierarchyContextUIElementCloseAllUILayouts(StringHash eventType, VariantMap& eventData);
