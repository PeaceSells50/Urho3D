...
//		}
	...
	void EPScene3D::Update(float timeStep)
	{
		...
		if (toolBarDirty && toolBarVisible)
			UpdateToolBar();
...
// 				miniToolBarButtons_.Push(b);
	...
	void EPScene3D::CreateToolBarUI()
	{
		...
		UIElement* e = toolbar->CreateGroup("RunUpdateGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		CheckBox* checkbox = toolbar->CreateToolBarToggle("RunUpdateGroup", "RunUpdatePlay");
		...
		checkbox = toolbar->CreateToolBarToggle("RunUpdateGroup", "RunUpdatePause");
		...
		checkbox = toolbar->CreateToolBarToggle("RunUpdateGroup", "RevertOnPause");
		...
		toolbar->CreateToolBarSpacer(4);

		e = toolbar->CreateGroup("EditModeGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		checkbox = toolbar->CreateToolBarToggle("EditModeGroup", "EditMove");
		...
		checkbox = toolbar->CreateToolBarToggle("EditModeGroup", "EditRotate");
		...
		checkbox = toolbar->CreateToolBarToggle("EditModeGroup", "EditScale");
		...
		checkbox = toolbar->CreateToolBarToggle("EditModeGroup", "EditSelect");
		...
		e = toolbar->CreateGroup("AxisModeGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		checkbox = toolbar->CreateToolBarToggle("AxisModeGroup", "AxisWorld");
		...
		checkbox = toolbar->CreateToolBarToggle("AxisModeGroup", "AxisLocal");
		...
		toolbar->CreateToolBarSpacer(4);
		checkbox = toolbar->CreateToolBarToggle("MoveSnap");
		...
		checkbox = toolbar->CreateToolBarToggle("RotateSnap");
		...
		toolBarToggles.Push(checkbox);
		checkbox = toolbar->CreateToolBarToggle("ScaleSnap");
		...
		e = toolbar->CreateGroup("SnapScaleModeGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		checkbox = toolbar->CreateToolBarToggle("SnapScaleModeGroup", "SnapScaleHalf");
		...
		checkbox = toolbar->CreateToolBarToggle("SnapScaleModeGroup", "SnapScaleQuarter");
		...
		toolbar->CreateToolBarSpacer(4);
		e = toolbar->CreateGroup("PickModeGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		checkbox = toolbar->CreateToolBarToggle("PickModeGroup", "PickGeometries");
		...
		checkbox = toolbar->CreateToolBarToggle("PickModeGroup", "PickLights");
		...
		checkbox = toolbar->CreateToolBarToggle("PickModeGroup", "PickZones");
		...
		checkbox = toolbar->CreateToolBarToggle("PickModeGroup", "PickRigidBodies");
		...
		checkbox = toolbar->CreateToolBarToggle("PickModeGroup", "PickUIElements");
		...
		toolbar->CreateToolBarSpacer(4);
		e = toolbar->CreateGroup("FillModeGroup", LM_HORIZONTAL);
		toolBarToggles.Push(e);
		checkbox = toolbar->CreateToolBarToggle("FillModeGroup", "FillPoint");
		...
		checkbox = toolbar->CreateToolBarToggle("FillModeGroup", "FillWireFrame");
		...
		checkbox = toolbar->CreateToolBarToggle("FillModeGroup", "FillSolid");
